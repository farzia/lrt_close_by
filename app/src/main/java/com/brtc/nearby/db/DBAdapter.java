...
public class DBAdapter {
    ...
    public boolean saveNewLrt(String name, String location, String longitude, String latitude){
        db.execSQL("INSERT INTO bus_stopages(name, location, latitude, longitude) VALUES ('" + name + "', '" +  location + "', '" + longitude +"', '" + latitude +"')");
        return true;
    }

    public boolean saveNewUser(String name, String username, String password){
        db.execSQL("INSERT INTO user(name, username, password) VALUES ('" + name + "', '" +  username + "', '" + password +"')");
        return true;
    }
